"""Unit tests for vector_os.core.config — TDD RED phase.
...
class TestConfigErrorExists:
    def test_config_error_importable(self):
        from vector_os.core.config import ConfigError  # noqa: F401
...
class TestDefaultConfig:
    ...
    def test_default_skills_section(self):
        ...
        assert cfg["skills"]["pick"]["z_offset"] == 0.12
...
class TestUserOverrideYAMLPath:
    ...
    def test_missing_yaml_file_raises(self):
        from vector_os.core.config import ConfigError, load_config
...
class TestConfigValidation:
    def test_valid_default_passes_validation(self):
        from vector_os.core.config import load_config, validate_config
    ...
    def test_invalid_planning_retries_type(self):
        ...
        from vector_os.core.config import ConfigError, validate_config
...
class TestGetSection:
    def test_get_existing_section(self):
        from vector_os.core.config import get_section, load_config
