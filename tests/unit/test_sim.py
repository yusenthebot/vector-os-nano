...
class TestSimulatedArmProtocolCompliance:
    ...
    def test_isinstance_arm_protocol(self) -> None:
        from vector_os.hardware.arm import ArmProtocol
        from vector_os.hardware.sim.pybullet_arm import SimulatedArm
...
class TestSimulatedGripperProtocolCompliance:
    ...
    def test_isinstance_gripper_protocol(self) -> None:
        from vector_os.hardware.gripper import GripperProtocol
        from vector_os.hardware.sim.pybullet_gripper import SimulatedGripper
...
class TestSimPackageExports:
    ...
    def test_import_simulated_arm(self) -> None:
        from vector_os.hardware.sim import SimulatedArm  # noqa: F401

    def test_import_simulated_gripper(self) -> None:
        from vector_os.hardware.sim import SimulatedGripper  # noqa: F401
    ...
    def test_simulated_gripper_is_class(self) -> None:
        from vector_os.hardware.sim import SimulatedGripper
