...
Each skill implements the Skill protocol (vector_os.core.skill).
...
from vector_os.skills.detect import DetectSkill
from vector_os.skills.home import HomeSkill
from vector_os.skills.pick import PickSkill
from vector_os.skills.place import PlaceSkill
from vector_os.skills.scan import ScanSkill
