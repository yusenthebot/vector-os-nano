...
Usage:
    ...
    if ROS2_AVAILABLE:
        from vector_os.ros2 import HardwareBridgeNode, PerceptionBridgeNode
...
if ROS2_AVAILABLE:
    ...
    from vector_os.ros2.nodes.perception_node import PerceptionBridgeNode
    from vector_os.ros2.nodes.skill_server import SkillServerNode
    from vector_os.ros2.nodes.world_model_node import WorldModelServiceNode
    from vector_os.ros2.nodes.agent_node import AgentNode
